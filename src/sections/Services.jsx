...
const Services = () => {
    return (
        <section id="about" className="w-full flex flex-col justify-center items-center gap-10 max-container">
            ...
            <div className="grid xl:grid-cols-2 grid-cols-1 gap-12 xl:gap-20 w-full">
                ...
                <div id='faq' className="bg-white shadow-lg rounded-lg p-8">
